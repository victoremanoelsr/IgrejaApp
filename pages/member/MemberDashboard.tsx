  ...
  return (
    <div className="space-y-6">
      ...
      <div>
        ...
        <h1 className="text-2xl font-bold text-gray-800">{firstNameFormatted} 👋</h1>
      </div>

      {/* Tithes Card */}
      <div className="relative bg-gradient-to-br from-orange-500 to-orange-700 rounded-xl p-5 shadow-md overflow-hidden">
      ...
      <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-4">
        <div className="flex items-center gap-3">
          ...
          <div className="min-w-0 flex-1">
            <p className="text-gray-800 font-semibold text-sm truncate">{member.name}</p>
            <p className="text-gray-500 text-xs">{church.name}</p>
            {member.memberNumber && (
              <p className="text-gray-400 text-xs">Nº {member.memberNumber}</p>
            )}
          </div>
          <span
