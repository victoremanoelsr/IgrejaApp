...
export const MemberDocumentos: React.FC = () => {
  return (
    <div className="space-y-6 max-w-2xl">
      ...
      <button className="w-full flex items-center justify-center gap-2 bg-white hover:bg-gray-50 border border-gray-200 text-gray-600 font-semibold py-3 rounded-xl transition-all text-sm shadow-sm">
        <Mail size={16} />
        Entrar em Contato
      </button>
    </div>
