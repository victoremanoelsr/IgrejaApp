  ...
  const renderDashboard = () => {
      ...
      <div className="space-y-6">
          ...
          <div className="grid grid-cols-12 gap-6">
              ...
              <div className="col-span-12 md:col-span-8 bg-white rounded-xl shadow-sm border-l-4 border-pink-500 p-6 flex flex-col justify-center relative overflow-hidden">
                            ...
                            <div className="flex items-center gap-3">
                                ...
                                <div className="min-w-0">
                                    ...
                                    <div className="flex flex-wrap items-center gap-2 mt-0.5">
                                        ...
                                        <span className="bg-pink-100 text-pink-700 text-[9px] px-1.5 py-0.5 rounded font-bold uppercase tracking-tight shrink-0">Senhoras</span>
                                    </div>
                                </div>
                            </div>
                            <div className="flex items-center gap-2 shrink-0">
                                <button onClick={() => toggleLadyMember(m)} className="p-2 text-gray-300 hover:text-red-500 transition-colors" title="Remover"><Trash2 size={16}/></button>
                            </div>
                        </div>
                    ))}
