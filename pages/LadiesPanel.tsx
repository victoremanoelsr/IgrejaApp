...
export const LadiesPanel: React.FC = () => {
  ...
  const yearlyTransactions = transactions.filter(t => t.churchId === currentChurch?.id && t.category === 'SENHORAS' && new Date(t.date).getFullYear() === dashYear);
  ...
  const renderDashboard = () => {
      ...
      transactions.forEach(t => {
          if (t.churchId === currentChurch?.id && t.category === 'SENHORAS' && t.status === 'PAGO') {
