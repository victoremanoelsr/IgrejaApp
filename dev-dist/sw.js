...
define(['./workbox-6eb19369'], (function (workbox) { 'use strict';
  ...
  workbox.registerRoute(/\.(?:js|css|woff2?|png|jpg|jpeg|svg|ico)$/i, new workbox.StaleWhileRevalidate({
